...
- Full live-transaction test table for the current release, including live proof of the new commitment-hardening and URL-hardening checks (every row mapped to what it tested and the observed result): `docs/DEPLOYMENT.md`, section "Live release proof (current release, `0xC8DC9930efA7276280E2E23BC59038420e97F747`)".
