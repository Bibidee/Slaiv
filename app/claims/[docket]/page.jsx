...
function ActionPanel({claim,policy,isClaimant,connected,run,tx}){
  ...
  return <section className="case-panel action-panel"><p className="eyebrow">AVAILABLE ACTIONS</p>
    ...
    {claim.state==='AWAITING_FINALITY'?<div className="finality-boundary"><strong>Protocol finality pending</strong><p>No operator approval is required. Any connected wallet may submit an official GenLayer event for consensus verification. SLAIV advances only if independent validators agree that the source proves a matching final protocol event.</p></div>:null}
